...
public sealed class PackagedAppAttachesToTheFrameTests
{
    ...
    public void APackagedApplication_AttachesToItsFrame_NotToTheDoomedCoreWindow()
    {
        ...
        {
            // The driver's own teardown, and nothing after it. A KillAll here
            // was belt-and-braces that ended the developer's Calculator too - and
            // it hid whether the line above actually worked.
