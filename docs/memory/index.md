...
| [014-compatibility-and-deployment-targets.md](014-compatibility-and-deployment-targets.md) | Floor is Win10 1607 / Server 2016 — same as WinAppDriver, .NET is not the limiter. Real gaps: no /wd/hub, no CLI args, loopback-only, Desktop Runtime prerequisite. GitHub runners are 2022/2025/11-arm; windows-2019 is gone |
| [019-protocol-fixture-consolidation-and-guest-timeout-cluster.md](019-protocol-fixture-consolidation-and-guest-timeout-cluster.md) | 19/21 protocol fixtures boot a fresh WebApplicationFactory per test (local only, not guest-related — a conflation caught mid-session); plus a real ~8s timeout cluster on the guest suite, unrelated, not yet probed | 2026-08-08 |
